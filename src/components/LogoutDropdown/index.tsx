      ...
      <DropdownMenu.Portal>
        ...
        >
          <DropdownMenu.Item
            ...
            className="py-4 pl-2 pr-2 text-sm flex items-center gap-4 cursor-pointer z-[120] group text-[13px] leading-none text-zinc-300 rounded h-[25px] relative select-none outline-none data-[disabled]:text-zinc-400 data-[disabled]:pointer-events-none data-[highlighted]:bg-zinc-700 data-[highlighted]:text-blue-500"
          >
            <FiLogOut size={16} />
            Logout
          </DropdownMenu.Item>
